...
def test_ehr_patient_lookup_and_validation_use_cases(tmp_path):
    ...
    with TestClient(app) as client:
        missing_patient = client.get(
            "/rpc/find_patient",
            params={"name": "Missing Patient", "date_of_birth": "1990-01-02"},
        )
        ...
        invalid_range = client.get(
            "/rpc/list_availability_slots",
            params={"from_date": "2030-01-16", "to_date": "2030-01-15"},
        )
        ...
        missing_appointment_cancel = client.put(
            "/rpc/cancel_appointment",
...
def test_ehr_reuses_patients_and_lists_date_ranges(tmp_path):
    ...
    with TestClient(app) as client:
        ...
        range_response = client.get(
            "/rpc/list_availability_slots",
            params={"from_date": "2030-01-15", "to_date": "2030-01-16"},
        )
